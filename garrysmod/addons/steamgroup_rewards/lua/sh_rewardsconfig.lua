...
REWARDS.Settings.SteamGroupPage = "https://steamcommunity.com/groups/CeletialNetworks"
...
REWARDS.Settings.GroupName = "Celestial Networks"
...
REWARDS.Settings.RewardsMessage = "Join our steam group and get 20,000$!"
--Message box text on success (e.g. explain what rewards we're given)
REWARDS.Settings.RewardsSuccessMessage = "Thanks for joining the group! You have received your 20k!"
...
REWARDS.Settings.RewardsChatMessage = "Joined our steam group and received a reward!"
...
REWARDS.Settings.DarkRPCashReward = 20000 --DarkRP Cash Reward (Set to 0 to disable)
...
REWARDS.Settings.ULXGroup = "member" --Change to "" to disable
