...
function ENT:SetupDataTables()
	...
	self.CrclCfg.Name = "Circle Printer" -- The name of the printer...
	self.CrclCfg.FireUpChance = 0 -- Printer break chance
	self.CrclCfg.MaxMoney = 10000 -- Max money that it can hold
	self.CrclCfg.PrintInterval = 10 -- Interval in sec that it prints
	self.CrclCfg.PrintRate = 250 -- Prints this amount of the money if it have 100% upgraded speed + exp money added to this 1lvl = 1/4 of this number
	self.CrclCfg.SpeedUpgradePrice = 1000 -- Price for the speed upgrade
	self.CrclCfg.CoolingUpgradePrice = 2500 -- Price for the cooling upgrade
	self.CrclCfg.PlusSpeed = 20 -- If you push upgrade speed it will upgrade that much
	self.CrclCfg.ModelColor = Color(145, 145, 120, 255) -- Printer main model color
