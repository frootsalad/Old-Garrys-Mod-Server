...
function ENT:SetupDataTables()
	...
	self.CrclCfg.Name = "Platinum Printer" -- The name of the printer...
	self.CrclCfg.FireUpChance = 5 -- Printer break chance
	self.CrclCfg.MaxMoney = 15000 -- Max money that it can hold
	self.CrclCfg.PrintInterval = 10 -- Interval in sec that it prints
	self.CrclCfg.PrintRate = 500 -- Prints this amount of the money if it have 100% upgraded speed + exp money added to this 1lvl = 1/4 of this number
	self.CrclCfg.SpeedUpgradePrice = 2500 -- Price for the speed upgrade
	self.CrclCfg.CoolingUpgradePrice = 7500 -- Price for the cooling upgrade
