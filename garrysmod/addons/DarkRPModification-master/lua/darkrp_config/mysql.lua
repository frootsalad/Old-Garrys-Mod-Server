...
RP_MySQLConfig.Password = "eDKWcLsz5Ht79sXnHrDavD1VproDU2FX" -- This is the Password to log in on the MySQL server,
...
RP_MySQLConfig.MultiStatements = true -- Only available in tmysql4: allow multiple SQL statements per query. Has no effect if no scripts use it.
